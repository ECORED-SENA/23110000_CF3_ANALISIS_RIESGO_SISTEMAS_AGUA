...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-content-center.mb-5
      ...
      .col-lg-7.align-self-center
        figure.pt-2.flex-end
          img.img80(src='@/assets/curso/tema1/img02.svg')
        ...
        figure.mb-4.flex-end
          img.img10(src='@/assets/curso/tema1/img03.svg')
    
    .row
      .col-lg-2
        figure.mb-4
          img.img170(src='@/assets/curso/tema1/img04.svg' data-aos="zoom-out-right")
      .col-lg-10
        p En palabras de Amézquita, Pérez y Torres (2014):
    .row
      .col-lg-2
        figure.mb-4.pe-2.flex-end
          img.img10(src='@/assets/curso/tema1/img05.svg')
      .col-lg-9
        p.ps-1 La evaluación del riesgo es un instrumento de gestión para empresas prestadoras del servicio que permite priorizar recursos humanos y financieros hacia el mejoramiento de las medidas de control como estrategia para reducir los riesgos y asegurar la calidad del agua potable en el sistema de distribución de agua. 
         figure.mb-4.flex-end
          img.img100(src='@/assets/curso/tema1/img07.svg')
      .col-lg-1.align-item-center
        figure.flex-end.p-2.pt-0
          img.img4113(src='@/assets/curso/tema1/img06.svg')
    
    separador

    #t_1_1.titulo-segundo.color-secundario(style="color: #A6E65A")(data-aos="zoom-out-right")
      h2 1.1.	Instructivos de almacenamiento, manejo y transporte de sustancias peligrosas

    .row.justify-content-center.align-content-center.mb-5
      .col-lg-5.align-self-center
        figure(data-aos="fade-right")
          img.img80(src="@/assets/curso/tema1/img08.svg") 
        figure(data-aos="zoom-in-down")
          img(src="@/assets/curso/tema1/img09.svg")       
      .col-lg-7.align-self-center
        figure.pt-2.flex-end.mb-5
          img.img90(src='@/assets/curso/tema1/img02.svg')
    ...
    p.mb-2 Sustancias más empleadas en sistemas de potabilización de agua
    ...
    .row
      ...
      .col-lg-5
        figure.mb-4
          img(src='@/assets/curso/tema1/img10.svg')(data-aos="fade-left")
      ...
      .tarjeta.bg07.col-12.col-md-10.mx-auto.d-flex.flex-wrap.flex-md-nowrap.mb-5.mt-5
        ...
        .my-auto.position-relative
          ...
          .w-100.d-flex.justify-content-center.pe-0.pe-md-5.mt-5
            ...
            img(src="@/assets/curso/tema1/img30.svg" data-aos="fade-left" style="max-width: 36px")
        img(src="@/assets/curso/tema1/img29.png" style="max-width: 116px; position: absolute; right: 3%; top: 50%; transform: translateY(-50%);")

    separador
    #t_1_2.titulo-segundo.color-secundario(style="color: #491079" data-aos="zoom-out-right")
          ...
          p.mb-2.ms-5.me-4.mt-5 Al igual que los instructivos de almacenamiento, manejo y transporte de sustancias peligrosas, la estructura de los instructivos de operación y mantenimiento es similar:
           TabsA.color-acento-botones.mt-4
            ...
            .tarjeta.color-acento-botones--borde.p-4(titulo="Condiciones para el almacenamiento, manejo y transporte de sustancias químicas.")
              h4 Condiciones para el almacenamiento, manejo y transporte de sustancias químicas. 
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-md-4
            figure.flex-end
             img.img10.mt-4(src="@/assets/curso/tema1/img33.svg") 
            figure
              img.mb-5(src='@/assets/curso/tema1/img34.svg', alt='Texto que describa la imagen')
