...
.banner-principal
  .container.tarjeta.position-relative(
    ...
    .row.banner-principal__row.position-relative.justify-content-center.align-items-center
      .col-lg-7.col-xxl-6.py-4.py-sm-5.banner-principal__info.ps-5
        ...
        .banner-principal__accion
          router-link.boton.mt-4(:to="{name: iniciarLnk.nombreRuta }")
            span.me-1 Iniciar
    ...
    //*.imagen_flotante_5.d-none.d-xl-block: img(src="@/assets/curso/portada/float4.png")
    //*.imagen_flotante_6.d-none.d-xl-block: img(src="@/assets/curso/portada/float5.png")
